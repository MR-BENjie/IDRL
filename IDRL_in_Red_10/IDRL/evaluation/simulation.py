...
def load_card_play_models_R_10(model_dict , model_relation, model_dangerous):
    ...
    from IDRL.dmc.relation_decition import Relation_score_Model,Dangerous_Model
    import torch
...
def mp_simulate_R_10(players ,model_relation,model_dangerous, q,num):
    from IDRL.env.rlcard_red10.rlcard.envs.red_10 import Red_10Env
    from IDRL.dmc.utils import Environment_R_D
    import torch
